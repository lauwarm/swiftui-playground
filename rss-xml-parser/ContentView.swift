...
struct ContentView: View {
    ...
    func loadData(){
        ...
        let urlArray = [NSURL(string: "https://rss.nytimes.com/services/xml/rss/nyt/Europe.xml"), NSURL(string: "https://rss.nytimes.com/services/xml/rss/nyt/World.xml"), NSURL(string: "https://www.tagesschau.de/xml/rss2/")]
